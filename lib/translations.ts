export const translations = {
  en: {
    ...
    pdfLabels: {
      ...
      company: "Company",
      position: "Position",
      assessmentResults: "Cybersecurity Assessment Results",
    ...
    email: {
      subject: "Your E-Invoicing Assessment Report",
      greeting: "Dear",
      body: "Thank you for completing the E-Invoicing Assessment. Please find your detailed assessment report attached to this email.",
      appointmentText: "To book an appointment with our team, please send an email to",
      appointmentEmail: "anisha@cs.rsm.ae",
      closing: "Best regards,\nRSM MENA Team"
    },
    assessmentGuidance: {
      title: "E-Invoicing Assessment Guidelines",
      instructions: "Guidelines",
      instructionsDescription: "This e-invoicing assessment consists of various question types to gather comprehensive information about your organization's e-invoicing requirements and current setup. Please answer all questions accurately to help us understand your needs.",
      questionTypes: {
        yesno: {
          label: "Yes/No Questions",
          description: "Select Yes or No for questions requiring a binary answer"
        },
        text: {
          label: "Text Questions",
          description: "Provide detailed answers in the text field provided"
        },
        number: {
          label: "Number Questions",
          description: "Enter numerical values (e.g., invoice counts, number of entities)"
        },
        select: {
        ...
        ynlist: {
          label: "Yes/No List",
          description: "Answer Yes or No for each item in the list"
        }
      },
      scoring: "Instructions: Please answer all questions accurately to help us understand your e-invoicing requirements. You can navigate between questions using the Back and Next buttons. All questions are required.",
  ...
  fr: {
    ...
    email: {
      subject: "Votre Rapport d'Évaluation de Cybersécurité",
      greeting: "Cher/Chère",
      body: "Merci d'avoir complété l'auto-évaluation de cybersécurité. Veuillez trouver votre rapport d'évaluation détaillé joint à cet e-mail.",
    ...
    assessmentGuidance: {
      ...
      instructionsDescription: "Cette évaluation consiste en des questions à choix unique. Chaque question a quatre options de réponse, et chaque option se voit attribuer des points en fonction du niveau de maturité des pratiques de cybersécurité de votre organisation :",
      points: {
        eight: {
          label: "Avancé/Mature",
          description: "Entièrement intégré, continu et aligné avec les cadres de l'industrie"
        },
        five: {
          label: "Modéré",
          description: "Défini et examiné périodiquement au niveau supérieur"
        },
        three: {
          label: "De Base",
          description: "Effectué de manière ad-hoc ou de façon incohérente"
        },
        zero: {
          label: "Non en place",
          description: "Aucune stratégie ou processus formel n'existe"
        }
      },
      scoring: "Notation : Votre score total sera calculé en additionnant les points de toutes vos réponses. L'évaluation vous fournira un niveau de maturité en cybersécurité basé sur votre score total.",
      disclaimer: "Avertissement",
      disclaimerText: "Cette évaluation ne garantit pas la détection de toutes les vulnérabilités, menaces ou exploits existants ou potentiels. Elle reflète la posture de sécurité de l'organisation au moment des tests uniquement sur la base de vos réponses aux questions d'évaluation. Le rapport d'évaluation est destiné uniquement à votre usage interne et ne doit pas être distribué, divulgué ou utilisé par des tiers. RSM ne sera pas responsable de toute perte, dommage, réclamation ou dépense découlant de, ou en relation avec, l'utilisation des résultats de l'évaluation.",
  ...
  ar: {
    ...
    email: {
      subject: "تقرير تقييم الأمن السيبراني الخاص بك",
      greeting: "عزيزي/عزيزتي",
      body: "شكراً لك على إكمال التقييم الذاتي للأمن السيبراني. يرجى الاطلاع على تقرير التقييم المفصل المرفق بهذا البريد الإلكتروني.",
    ...
    assessmentGuidance: {
      ...
      instructionsDescription: "يتكون هذا التقييم من أسئلة اختيار واحد. كل سؤال له أربع خيارات للإجابة، ويتم تعيين نقاط لكل خيار بناءً على مستوى نضج ممارسات الأمن السيبراني في مؤسستك:",
      points: {
        eight: {
          label: "متقدم/ناضج",
          description: "متكامل بالكامل ومستمر ومتوافق مع أطر الصناعة"
        },
        five: {
          label: "معتدل",
          description: "محدد ومراجع بشكل دوري على المستوى الإداري"
        },
        three: {
          label: "أساسي",
          description: "يتم تنفيذه بشكل عرضي أو غير متسق"
        },
        zero: {
          label: "غير موجود",
          description: "لا توجد استراتيجية أو عملية رسمية"
        }
      },
      scoring: "النقاط: سيتم حساب إجمالي نقاطك عن طريق جمع النقاط من جميع إجاباتك. سيوفر لك التقييم مستوى نضج الأمن السيبراني بناءً على إجمالي نقاطك.",
      disclaimer: "إخلاء المسؤولية",
      disclaimerText: "لا يضمن هذا التقييم اكتشاف جميع الثغرات أو التهديدات أو الاستغلالات الموجودة أو المحتملة. إنه يعكس وضع أمان المؤسسة في وقت الاختبار فقط بناءً على إجاباتك على أسئلة التقييم. تقرير التقييم مخصص للاستخدام الداخلي فقط ولا يجب توزيعه أو الكشف عنه أو الاعتماد عليه من قبل أطراف ثالثة. لن تكون RSM مسؤولة عن أي خسائر أو أضرار أو مطالبات أو نفقات ناشئة عن أو فيما يتعلق باستخدام نتائج التقييم.",
